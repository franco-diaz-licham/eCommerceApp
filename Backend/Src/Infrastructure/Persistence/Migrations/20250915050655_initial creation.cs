        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Line2 = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    RemoteId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    NameNormalized = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientSecret = table.Column<string>(type: "varchar(256)", unicode: false, maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_State = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
                    ShippingAddress_PostalCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    ShippingAddress_Country = table.Column<string>(type: "nvarchar(56)", maxLength: 56, nullable: false),
