...
public sealed record CouponInfoModel(string RemoteId, string Name, string PromotionCodeId, string PromotionCode, long? AmountOff = null, decimal? PercentOff = null);
