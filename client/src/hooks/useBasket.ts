import { useClearBasketMutation, useFetchBasketQuery } from "../features/basket/services/basketApi";
...
export const useBasket = () => {
    ...
    const subtotal = basket?.items.reduce((sum: number, item: BasketItemResponse) => sum + item.quantity * item.price, 0) ?? 0;
