...
import type { FilterOptionModel } from "../components/Filters";
...
export default function ProductsPage() {
    ...
    const toCardDto = (p: ProductResponse): ProductCardModel => ({
        id: p.id,
        name: p.name,
        unitPrice: p.unitPrice,
        photoUrl: p.photo?.publicUrl,
    });
    const cardProducts: ProductCardModel[] = (data.response ?? []).map(toCardDto);
